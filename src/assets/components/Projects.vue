...
export default {
  ...
  methods: {
    ...
    getApiUrl() {
      ...
      // Para desarrollo y producción, usar localhost por ahora
      ...
      this.projects = [
        {
          ...
          description: "Mi sitio web personal desarrollado con Vue.js",
          imageUrl: "https://via.placeholder.com/400x300/4F46E5/ffffff?text=Portfolio",
          link: "https://gildcode.github.io"
        },
        {
          title: "Aplicación de Tareas",
          description: "Gestión de tareas con Vue.js y localStorage",
          imageUrl: "https://via.placeholder.com/400x300/059669/ffffff?text=Todo+App",
          link: "https://github.com/GildCode"
        },
        {
          title: "Dashboard Administrativo",
          description: "Panel con gráficos y estadísticas en tiempo real",
          imageUrl: "https://via.placeholder.com/400x300/DC2626/ffffff?text=Dashboard",
          link: "https://github.com/GildCode"
        }
      ]
    }
  ...
  <section id="projects" class="py-20 bg-white text-gray-800">
    <div class="container mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
      ...
      <div v-else-if="error && projects.length === 0" class="text-center py-12">
        ...
        <p class="text-gray-600">Error al cargar proyectos. Usando datos de ejemplo.</p>
      </div>
